...
export const catalog = [
  {
    ...
    name: "Japan Rule",
    status: "public",
    summary: "Machine-readable entry guidance for businesses and authorized AI agents that want to launch an experiential tour in Japan but need to understand what to check first. It organizes official sources, likely consultation points, and missing facts through reusable model cases; it does not provide bookable inventory.",
    useCases: ["Research official sources for Japanese ecommerce advertising, returns, or cancellation terms", "Prepare a business consultation about entering the Japanese experiential-tourism market", "Use the Iya English soba-workshop model case to identify scope, consultation points, and missing facts", "日本向けECの通販広告表示を確認する", "日本の体験型ツアー観光への参入で必要な公式根拠・相談先・未確認事項を整理する"],
    ...
    freeOffer: "Start with a free scope check to identify official sources, likely consultation points, missing facts, and current purchase terms for a Japan experiential-tourism model case.",
    ...
    exampleOutput: "The free MCP call returns the model-case scope, official-source pointers, likely consultation points, unconfirmed facts, and current business purchase terms. The paid pack returns source references, contacts, inquiry text, and next actions after x402 settlement.",
